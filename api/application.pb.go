...
type TestPayloadDecoderRequest struct {
	// The id of the application.
	Id int64 `protobuf:"varint,1,opt,name=id" json:"id,omitempty"`
	// HEX encoded bytes.
...
func (m *TestPayloadDecoderRequest) Reset()                    { *m = TestPayloadDecoderRequest{} }
func (m *TestPayloadDecoderRequest) String() string            { return proto.CompactTextString(m) }
func (*TestPayloadDecoderRequest) ProtoMessage()               {}
func (*TestPayloadDecoderRequest) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{18} }

func (m *TestPayloadDecoderRequest) GetId() int64 {
	if m != nil {
		return m.Id
	}
	return 0
...
func (m *TestPayloadDecoderRequest) GetData() string {
	if m != nil {
		return m.Data
	}
	return ""
...
type TestPayloadDecoderResponse struct {
	// JSON string representation of the decoded data.
	Json string `protobuf:"bytes,1,opt,name=json" json:"json,omitempty"`
}

func (m *TestPayloadDecoderResponse) Reset()                    { *m = TestPayloadDecoderResponse{} }
func (m *TestPayloadDecoderResponse) String() string            { return proto.CompactTextString(m) }
func (*TestPayloadDecoderResponse) ProtoMessage()               {}
func (*TestPayloadDecoderResponse) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{19} }

func (m *TestPayloadDecoderResponse) GetJson() string {
	if m != nil {
		return m.Json
	}
	return ""
...
type TestPayloadEncoderRequest struct {
	// The id of the application.
	Id int64 `protobuf:"varint,1,opt,name=id" json:"id,omitempty"`
	// JSON string representation of the data to encode.
	Json string `protobuf:"bytes,2,opt,name=json" json:"json,omitempty"`
}

func (m *TestPayloadEncoderRequest) Reset()                    { *m = TestPayloadEncoderRequest{} }
func (m *TestPayloadEncoderRequest) String() string            { return proto.CompactTextString(m) }
func (*TestPayloadEncoderRequest) ProtoMessage()               {}
func (*TestPayloadEncoderRequest) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{20} }

func (m *TestPayloadEncoderRequest) GetId() int64 {
	if m != nil {
		return m.Id
	}
	return 0
...
func (m *TestPayloadEncoderRequest) GetJson() string {
	if m != nil {
		return m.Json
	}
	return ""
...
type TestPayloadEncoderResponse struct {
	// HEX encoded bytes.
	Data string `protobuf:"bytes,1,opt,name=data" json:"data,omitempty"`
}

func (m *TestPayloadEncoderResponse) Reset()                    { *m = TestPayloadEncoderResponse{} }
func (m *TestPayloadEncoderResponse) String() string            { return proto.CompactTextString(m) }
func (*TestPayloadEncoderResponse) ProtoMessage()               {}
func (*TestPayloadEncoderResponse) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{21} }

func (m *TestPayloadEncoderResponse) GetData() string {
	if m != nil {
		return m.Data
	}
	return ""
...
func init() {
	...
	proto.RegisterType((*TestPayloadDecoderRequest)(nil), "api.TestPayloadDecoderRequest")
	proto.RegisterType((*TestPayloadDecoderResponse)(nil), "api.TestPayloadDecoderResponse")
	proto.RegisterType((*TestPayloadEncoderRequest)(nil), "api.TestPayloadEncoderRequest")
	proto.RegisterType((*TestPayloadEncoderResponse)(nil), "api.TestPayloadEncoderResponse")
...
type ApplicationClient interface {
	...
	// TestPayloadDecoder tests the payload decoder for the given application.
	TestPayloadDecoder(ctx context.Context, in *TestPayloadDecoderRequest, opts ...grpc.CallOption) (*TestPayloadDecoderResponse, error)
	// TestPayloadEncoder tests the payload encoder for the given application.
	TestPayloadEncoder(ctx context.Context, in *TestPayloadEncoderRequest, opts ...grpc.CallOption) (*TestPayloadEncoderResponse, error)
}
...
func (c *applicationClient) TestPayloadDecoder(ctx context.Context, in *TestPayloadDecoderRequest, opts ...grpc.CallOption) (*TestPayloadDecoderResponse, error) {
	out := new(TestPayloadDecoderResponse)
	err := grpc.Invoke(ctx, "/api.Application/TestPayloadDecoder", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *applicationClient) TestPayloadEncoder(ctx context.Context, in *TestPayloadEncoderRequest, opts ...grpc.CallOption) (*TestPayloadEncoderResponse, error) {
	out := new(TestPayloadEncoderResponse)
	err := grpc.Invoke(ctx, "/api.Application/TestPayloadEncoder", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type ApplicationServer interface {
	...
	// TestPayloadDecoder tests the payload decoder for the given application.
	TestPayloadDecoder(context.Context, *TestPayloadDecoderRequest) (*TestPayloadDecoderResponse, error)
	// TestPayloadEncoder tests the payload encoder for the given application.
	TestPayloadEncoder(context.Context, *TestPayloadEncoderRequest) (*TestPayloadEncoderResponse, error)
}
...
func _Application_TestPayloadDecoder_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(TestPayloadDecoderRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ApplicationServer).TestPayloadDecoder(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/api.Application/TestPayloadDecoder",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ApplicationServer).TestPayloadDecoder(ctx, req.(*TestPayloadDecoderRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _Application_TestPayloadEncoder_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(TestPayloadEncoderRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ApplicationServer).TestPayloadEncoder(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/api.Application/TestPayloadEncoder",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ApplicationServer).TestPayloadEncoder(ctx, req.(*TestPayloadEncoderRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var _Application_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "TestPayloadDecoder",
			Handler:    _Application_TestPayloadDecoder_Handler,
		},
		{
			MethodName: "TestPayloadEncoder",
			Handler:    _Application_TestPayloadEncoder_Handler,
		},
	},
...
var fileDescriptor1 = []byte{
	...
	,
}
