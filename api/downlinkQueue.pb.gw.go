...
func RegisterDownlinkQueueHandler(ctx context.Context, mux *runtime.ServeMux, conn *grpc.ClientConn) error {
	return RegisterDownlinkQueueHandlerClient(ctx, mux, NewDownlinkQueueClient(conn))
}

// RegisterDownlinkQueueHandler registers the http handlers for service DownlinkQueue to "mux".
// The handlers forward requests to the grpc endpoint over the given implementation of "DownlinkQueueClient".
// Note: the gRPC framework executes interceptors within the gRPC handler. If the passed in "DownlinkQueueClient"
// doesn't go through the normal gRPC flow (creating a gRPC client etc.) then it will be up to the passed in
// "DownlinkQueueClient" to call the correct interceptors.
func RegisterDownlinkQueueHandlerClient(ctx context.Context, mux *runtime.ServeMux, client DownlinkQueueClient) error {
