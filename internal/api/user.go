...
func (a *UserAPI) CreateUser(ctx context.Context, req *pb.UserAddRequest) (*pb.UserAddResponse, error) {
	...
	return &pb.UserAddResponse{ Id: id }, nil
}

func (a *UserAPI) GetUser(ctx context.Context, req *pb.UserRequest) (*pb.UserResponse, error) {
...
func (a *UserAPI) GetUserList(ctx context.Context, req *pb.UserListRequest) (*pb.UserListResponse, error) {
...
func (a *UserAPI) UpdateUser(ctx context.Context, req *pb.UserUpdateRequest) (*pb.UserEmptyResponse, error) {
...
func (a *UserAPI) DeleteUser(ctx context.Context, req *pb.UserRequest) (*pb.UserEmptyResponse, error) {
...
func (a *UserAPI) UpdateUserPassword(ctx context.Context, req *pb.UserPasswordRequest) (*pb.UserEmptyResponse, error) {
