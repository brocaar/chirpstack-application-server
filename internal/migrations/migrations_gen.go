...
func _0013_users_and_application_usersSql() (*asset, error) {
	...
	info := bindataFileInfo{name: "0013_users_and_application_users.sql", size: 1443, mode: os.FileMode(420), modTime: time.Unix(1489480371, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
