        ...
        <form onSubmit={this.handleSubmit}>
          ...
          <div className={(this.state.activeTab === "join" ? "" : "hidden")}>
            ...
            <div className={"form-group " + (this.state.deviceProfile.deviceProfile.supportsJoin === true ? "hidden" : "")}>
              ...
              <input className="form-control" id="factoryPresetFreqsStr" type="text" placeholder="e.g. 860100000, 868300000, 868500000" required={!this.state.deviceProfile.deviceProfile.supportsJoin} value={this.state.deviceProfile.deviceProfile.factoryPresetFreqsStr || ''} onChange={this.onChange.bind(this, 'deviceProfile.factoryPresetFreqsStr')} />
              <p className="help-block">
