    ...
    return (
      <div>
        ...
        <ul className="nav nav-tabs">
          ...
          <li role="presentation" className={(activeTab === "edit" ? 'active' : '') + (this.state.isAdmin ? '' : 'hidden')}><Link to={`/organizations/${this.props.params.organizationID}/applications/${this.props.params.applicationID}/edit`}>Application settings</Link></li>
