    ...
    return (
      <div>
        ...
        <ul className="nav nav-tabs">
          ...
          <li role="presentation" className={activeTab.startsWith("device-profiles") ? 'active' : ''}><Link to={`/organizations/${this.props.params.organizationID}/device-profiles`}>Device profiles</Link></li>
        </ul>
        <hr />
        {this.props.children} 
      </div>
